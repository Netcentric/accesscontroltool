...
public class AcHelperTest {
    ...
    public void getMergedACLTest() {
        ...
        assertEquals(resultSet, AcHelper.getMergedACL(aclfromConfig,
                aclFomRepository, authorizablesSet, history));

        aclFomRepository.clear();
        resultSet.clear();

        // case2: old obsolete ACE (A_2) in repo gets deleted, new ACEs (A_1,
        // B_2) get added
        ...
        // case3: old obsolete ACE (A_2) in repo gets deleted, D_1 stays since
        // its no group from config
        // B_2 gets added
        ...
        assertNotEquals(resultSet, AcHelper.getMergedACL(aclfromConfig,
                aclFomRepository, authorizablesSet, history));
