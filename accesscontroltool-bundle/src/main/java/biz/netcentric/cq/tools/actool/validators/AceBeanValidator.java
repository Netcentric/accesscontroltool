...
public interface AceBeanValidator {
	...
	boolean validate(final AceBean aceBean) throws AcConfigBeanValidationException;

	boolean validateGlobbing(AceBean tmpAclBean) throws InvalidRepGlobException;

	boolean validatePermission(AceBean tmpAclBean) throws InvalidPermissionException;
	
	boolean validatePrivileges(AceBean tmpAclBean) throws NoActionOrPrivilegeDefinedException, InvalidJcrPrivilegeException, DoubledDefinedJcrPrivilegeException;

	boolean validateActions(AceBean tmpAclBean) throws InvalidActionException, TooManyActionsException, DoubledDefinedActionException;

	boolean validateAcePath(AceBean tmpAclBean) throws InvalidPathException;

	boolean validateAuthorizableId(Set<String> groupsFromCurrentConfig, AceBean tmpAclBean) throws NoGroupDefinedException, InvalidGroupNameException;
