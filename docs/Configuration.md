...
members | comma separated list of groups that are member of this group, allows to specify the relationship from the other side. However, for readability purposes, prefer `isMemberOf` over `members` if possible. | optional
