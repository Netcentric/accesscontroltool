...
For automated testing of expected cq:actions for certain paths and authorizables, the [access-control-validator](https://github.com/Netcentric/access-control-validator) tool can be used.
